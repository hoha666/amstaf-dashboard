...
export default function SentOrdersPage() {
    ...
    const [page, setPage] = useState(0); // MUI zero-based; backend is 1-based
    ...
    const load = useCallback(
        async (signal?: AbortSignal) => {
            ...
            try {
                ...
                console.error("orders/sent load error", {
        ...
        <RoleGuard roles={["Admin", "Manager"]}>
            <DashboardLayout>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 2 }}>
                    <Typography variant="h5">سفارش‌های ارسال‌شده</Typography>
